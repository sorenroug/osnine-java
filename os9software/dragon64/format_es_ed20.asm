* From Eurohard OS-9 L1 2.0 (Spanish labels)

* Header for : Format
* Module size: $9E7  #2535
* Module CRC : $C0F4D3 (Good)
* Hdr parity : $C6
* Exec. off  : $0045  #69
...
useopt   fcc   "Use: FORMAT /devname <opts>"
         fcb   $0A
         fcc   "  opts: P  - Preparado"
         fcb   $0A
         fcc   /        "nombre del disco"/
         fcb   $0A
         fcc   /        'numero de pistas'/
         fcb   $0A
         fcc   /        1  - una cara/
         fcb   $0A
         fcc   /        2  - dos caras/
         fcb   $0A
         fcc   '        /sectores por cluster/'
         fcb   $0A
         fcb   $0D

formatgo fcc   'Formateando '
formaten equ   *
prompt   fcc   's (si), p (parametros) o n (no)'
         fcb   $0A
         fcc   'Su opcion ? '
prmptend equ   *
namask   fcc   'Nombre del disco: '
namasken equ   *

tracks80 fcc   '80 pistas? : '
tracksen equ   *
cluster  fcc   '2 sectores por cluster? '
syscbd  fcc   'Sector del sistema defectuoso, '
         fcb   $0D
fabort   fcc   'FORMAT ABORTADO'
faborten equ   *
         fcb   $0D
clsmme   fcc   'Sectores por Cluster erroneos'
         fcb   $0D
dblsided fcc   'Doble cara? '
gdsect   fcc   'Numero de sectores correctos: $'
gdsecten equ *
         emod
eom      equ   *
