...
* edition 5: Made compliant with 1900-2155
*******************
...
*****
* Date [t]
*   Print: month-name Dd, CcYy  Hh:Mm:Ss
*
...
CENTLOOP cmpb #100 compare against 100
 blo PRTYEAR if less than, branch
 subb #100  else subtract 100
 inca ...and increase the century
 bra CENTLOOP

PRTYEAR pshs b
 tfr a,b    transfer century to B
 bsr PRTNUM Print century
 puls b Print year
