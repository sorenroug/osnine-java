...
* work if a >= 128. Removed some H6309 code.
...
edition set 6
 ...
 mod RDSKEnd,RDSKNam,Drivr+Objct,ReEnt+2,RDSKEnt,size
...
L003F    bsr   TERMINAT        Deallocate all RAM Drive ram blocks
...
L0078    ldb   #1         Try to allocate 1 8K RAM block
 pshs A
 os9 F$AllRAM
 puls A
...
L00DE pshs x              Preserve LSW of sector #
 ...
 bhs TooHigh0          Sector # too large, exit with error
...
L00EE rolb
 ...
 beq TooHigh0 if 0, exit with sector error
L0100 pshs A save block number
 clrb
...
TooHigh0 leas 2,s          Eat X on stack
