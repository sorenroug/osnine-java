...
LDVEC clra
 tfr a,dp
 orcc #IRQMask+FIRQMask Set interrupt masks
 leau IORESET,pcr Reset I/O registers
 ldx ,u++
 pshs u,x
 clr ,x
 stx ,--s
 leax INTVEC,pcr Copy interrupt vectors
 ldu #$FFF2
 ldb #6
LDVEC10 ldy ,x++
 sty ,u++
...
* Os-9 System Entries
*
 fdb TICK+$FBE0-* Clock tick handler
...
* Actual Vector Entries
 fdb 0 Reserved
INTVEC fdb SWI3RQ+$FBF2-* Swi3
 fdb SWI2RQ+$FBF4-* Swi2
 fdb FIRQ+$FBF6-* Firq
 fdb IRQ+$FBF8-* Irq
 fdb SWIRQ+$FBFA-* Swi
 fdb NMI+$FBFC-* Nmi
