...
/*
#define HP9000       0      /* HP-9000 running HP-UX */
...
#ifdef UCB4X            /* Default to 7-bit masking, CRLF */
...
#ifndef OS9      /* Unix Open different for update  */
...
#ifdef UCB4X            /* TOPS-20 can't handle timeouts... */
 ...
 */
#ifdef HP9000   /* added by dlf to use HPUX ioctl */
#include "ioctl.h"   /* added for HP9000 ioctl defs */

flushinput()
{
   ioctl(ttyfd,TCFLSH,0);   /* flush the input buffer */
}
#else
