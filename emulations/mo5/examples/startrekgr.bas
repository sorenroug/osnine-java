...
260 CLEAR 400,,5
270 Z$="                         "
280 DEFGR$(0) = 0,0,0,24,24,0,0,0 : ' SPACE
290 DEFGR$(1) = 0,0,31,2,228,40,124,0 : ' ENTERPRISE
300 DEFGR$(2) = 67,227,116,56,28,46,7,2 : ' KLINGON
310 DEFGR$(3) = 0,24,24,90,153,153,126,24 : ' STARBASE
320 DEFGR$(4) = 0,0,84,56,124,56,84,0 : ' STAR
330 DIM G(8,8),C(9,2),K(3,3),N(3),Z(8,8),D(8),QUADRANT%(8,8)
...
1265 PRINT"THERE";X0$;B9;"STARBASE";X$;" IN THE GALAXY FOR"
1270 PRINT"RESUPPLYING YOUR SHIP."
...
1610 FOR I=1 TO 8:FOR J=1 TO 8: QUADRANT%(I,J) = 0:NEXT J,I
...
1720 FOR I=1 TO K3
1730 GOSUB 8590:A%=2:Z1=R1:Z2=R2
1780 GOSUB 8670:K(I,1)=R1:K(I,2)=R2:K(I,3)=S9*(0.5+RND(1))
1810 NEXT I
1820 IF B3<1 THEN 1910
1880 GOSUB 8590:A%=3:Z1=R1:B4=R1:Z2=R2:B5=R2:GOSUB 8670
1910 FOR I=1 TO S3
1920 GOSUB 8590:A%=4:Z1=R1:Z2=R2:GOSUB 8670
1970 NEXT I
1980 GOSUB 6430
...
2610 A%=0:Z1=K(I,1):Z2=K(I,2):GOSUB 8670:GOSUB 8590
2660 K(I,1)=Z1:K(I,2)=Z2:A%=2:GOSUB 8670
2700 NEXT I
2710 GOSUB 6000
2720 D1=0
...
3070 A%=0:Z1=INT(S1):Z2=INT(S2):GOSUB 8670
3080 C1%=INT(C1)
...
3240 IF QUADRANT%(INT(S2),INT(S1)) = 0 THEN 3360
...
3370 A%=1:Z1=INT(S1):Z2=INT(S2):GOSUB 8670:GOSUB 3910:T8=1
...
4580 K3=K3-1:K9=K9-1:Z1=K(I,1):Z2=K(I,2):A%=0:GOSUB 8670
...
5000 PRINT USING "               #,#";X3,Y3:A%=0:Z1=X:Z2=Y:GOSUB 8830
5050 IF Z3<>0 THEN 4920
5060 A%=2:Z1=X:Z2=Y:GOSUB 8830:IF Z3=0 THEN 5210
...
5210 A%=4:Z1=X:Z2=Y:GOSUB 8830:IF Z3=0 THEN 5280
5260 PRINT USING "STAR AT #,# ABSORBED TORPEDO ENERGY.";X3,Y3:GOSUB 6000
5270 GOTO 1990
5280 A%=3:Z1=X:Z2=Y:GOSUB 8830:IF Z3=0 THEN 4760
...
6360 END
6370 PRINT:PRINT"CONGRATULATION, CAPTAIN!"
6380 PRINT"THE LAST KLINGON BATTLE CRUISER MENACING";
6390 PRINT"THE FEDERATION HAS BEEN DESTROYED.":PRINT
...
6490 A%=3:Z1=I:Z2=J:GOSUB 8830:IF Z3=1 THEN 6580
6540 NEXT J
...
6780 PRINT O1$
6810 FOR I=1 TO 8
6820 FOR J=1 TO 8:PRINT" ";GR$(QUADRANT%(J,I));:NEXT J
6825 ON I GOSUB 6850,6900,6960,7020,7070,7120,7180,7240
6830 NEXT I
6840 PRINT O1$:RETURN
6850 PRINT USING "   STARDATE :####.#";T:RETURN
6900 PRINT "   CONDITION:";C$:RETURN
6960 PRINT USING "   QUADRANT :#,#";Q1,Q2:RETURN
7020 PRINT USING "   SECTOR   :#,#";S1,S2:RETURN
7070 PRINT USING "   TORPEDOES:##";P:RETURN
7120 PRINT USING "   ENERGY   :####";E+S:RETURN
7180 PRINT USING "   SHIELDS  :####";S:RETURN
7240 PRINT USING "   KLINGONS :##";K9:RETURN
...
8590 R1=INT(RND(1)*7.98+1.01):R2=INT(RND(1)*7.98+1.01):A%=0:Z1=R1:Z2=R2:GOSUB 8830:IF Z3=0 THEN 8590
8600 RETURN

8660 REM INSERT A% IN ARRAY FOR QUADRANT
8670 IF A% < 0 OR A%>4 THEN PRINT "ERROR":STOP
8680 QUADRANT%(Z2,Z1)=A%
8690 RETURN
...
8820 REM A% COMPARISON IN QUADRANT ARRAY
8830 Z1=INT(Z1+.5):Z2=INT(Z2+.5):Z3=0
8890 IF QUADRANT%(Z2,Z1) <> A% THEN RETURN
8900 Z3=1:RETURN
