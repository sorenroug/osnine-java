...
ZF057   LDU     #PIAPORTA                   *F057: CE A7 C0
        ...
        LDA     #$5F                     *F05D: 86 5F
        STA     ,U                       *F05F: A7 C4
        LDX     #M3E3F                   *F061: 8E 3E 3F
        STX     $02,U       Set PIA control lines
        LDX     #M0404                   *F066: 8E 04 04
        STX     $0E,U                    *F069: AF 4E
...
ZF1B3   BSR     ZF1CB                    *F1B3: 8D 16
        LDX     #M002D                   *F1B5: 8E 00 2D
        BSR     WAITLOOP                    *F1B8: 8D E8
        LDX     #M0032                   *F1BA: 8E 00 32
...
MF521   ANDA    $0D,U                    *F521: A4 4D
        ...
        PSHS    X,DP                     *F54C: 34 18
        LDX     #MF646                   *F54E: 8E F6 46
        STX     M0067                    *F551: 9F 67   Set a new address in FIRQ vector
        LDA     #$A7                     *F553: 86 A7
        TFR     A,DP                     *F555: 1F 8B
        LDY     #M20CD                   *F557: 10 8E 20 CD
        LDX     #M0370                   *F55B: 8E 03 70
        LDA     #$FF                     *F55E: 86 FF
...
ZF56A   JSR     WAITLOOP                    *F56A: BD F1 A2
        TST     ,U                       *F56D: 6D C4
        LDX     #M0649                   *F56F: 8E 06 49
        LDA     #$01                     *F572: 86 01
        STA     M00E4                    *F574: 97 E4
        ...
        ANDCC   #$EF                     *F57D: 1C EF    Allow IRQs
        LDA     #$FE                     *F57F: 86 FE
        STA     $02,U                    *F581: A7 42   Inhibit FIRQ in PIA
        CLR     M00E4                    *F583: 0F E4   Clear A7E4
        PULS    DP                       *F585: 35 08
        CMPY    #M20D3                   *F587: 10 8C 20 D3   Has U changed?
        BLS     ZF5F6                    *F58B: 23 69
        PSHS    Y                        *F58D: 34 20
        LDB     #$10                     *F58F: C6 10
...
ZF5F2   STD     $08,S                    *F5F2: ED 68
        CLRA                             *F5F4: 4F
        BRN     ZF63A                    *F5F5: 21 43
        PULS    X                        *F5F7: 35 10
        STX     M0067                    *F5F9: 9F 67
        RTS                              *F5FB: 39
...
ZFCDA   FCB     $18                      *FCDA: 18
        ...
        INC     -$08,Y                   *FCF1: 6C 38
        LSRB                             *FCF3: 54
        NEG     Z0000                    *FCF4: 00 00
        NEG     M0010                    *FCF6: 00 10
        FCB     $10                      *FCF8: 10
