...
public class IdentificationSector {
    ...
    /**
     * Load values into the object, given 256 bytes.
     */
    public void loadSector(IdentificationSector target, SectorSupport sector) {
        totalSectors = sector.readTriple(DD_TOT);
        sectorsPerTrack = sector.readByte(DD_TKS);
    }

    /**
     * Create 256 bytes with data from object.
     */
    public byte[] makeSector() {
